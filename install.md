# body_recomposition guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `body_recomposition/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `body_recomposition` folder and use the modules inside your notebooks :
...
```python
from body_recomposition.utils.paths import data_dir
data_dir()
```
